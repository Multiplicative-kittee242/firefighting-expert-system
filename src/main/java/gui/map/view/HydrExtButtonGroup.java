...
import gui.map.view.controls.HydrExtButton;
...
public class HydrExtButtonGroup extends HydrantButtonGroup {
    public HydrExtButtonGroup(HydrantButtonGroupSpec specification, TopologyModel topology, JLabel container) {
        super(specification, topology, container);
    }

    @Override
    protected Function<String, HydrantToggleButton> getButtonCreator() {
        return HydrExtButton::new;
    }
